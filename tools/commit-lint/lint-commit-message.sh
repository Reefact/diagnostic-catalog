...
SCOPES='analyzers|aspnetcore|cataloggen|cli|codestyle|core|mstest|netanalyzers|nunit|sonar|stylecop|syslib|trimming|xunit'
TYPES_HUMAN='feat, fix, build, chore, ci, docs, perf, refactor, revert, style, test'
SCOPES_HUMAN='analyzers, aspnetcore, cataloggen, cli, codestyle, core, mstest, netanalyzers, nunit, sonar, stylecop, syslib, trimming, xunit'
MAX=72
