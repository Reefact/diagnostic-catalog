...
| --- | --- | --- |
| `DiagnosticRuleDefinitionAnalyzer` | `DCAT0002`–`DCAT0004` | **analysed** — a generated catalogue is what it exists to check |
| `SuppressionUsageAnalyzer` | `DCAT0001`, `DCAT0006`, `DCAT0007`, `DCAT0009` | **skipped** — a suppression in a generated file is not the author's to fix |
