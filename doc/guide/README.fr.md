...
Les sept catalogues d'éditeurs sous `src/` sont la même mécanique à l'échelle — de 62 à 465
...
* [**Les trains de release**](release-trains.fr.md) — les neuf lignes, comment un projet en rejoint
