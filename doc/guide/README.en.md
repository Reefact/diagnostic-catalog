...
The nine vendor catalogues under `src/` are the same machinery at scale — from 62 rules to 465 —
...
* [**Release trains**](release-trains.en.md) — the eleven lines, how a project joins one, and the
