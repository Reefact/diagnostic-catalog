...
The eight vendor catalogues under `src/` are the same machinery at scale — from 62 rules to 465 —
...
* [**Release trains**](release-trains.en.md) — the ten lines, how a project joins one, and the
