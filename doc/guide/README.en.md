...
The six vendor catalogues under `src/` are the same machinery at scale — from 90 rules to 465 —
...
* [**Release trains**](release-trains.en.md) — the eight lines, how a project joins one, and the
