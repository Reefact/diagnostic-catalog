...
**The ten vendor catalogues** are constants. Referencing one gives you compile-checked references
...
catalogue — the same way the ten vendor catalogues in this repository are written.
