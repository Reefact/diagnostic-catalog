...
**The eight vendor catalogues** are constants. Referencing one gives you compile-checked references
...
catalogue — the same way the eight vendor catalogues in this repository are written.
