...
**The twelve vendor catalogues** are constants. Referencing one gives you compile-checked references
...
catalogue — the same way the twelve vendor catalogues in this repository are written.
