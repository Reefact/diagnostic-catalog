...
**The nine vendor catalogues** are constants. Referencing one gives you compile-checked references
...
catalogue — the same way the nine vendor catalogues in this repository are written.
