...
**Les sept catalogues d'éditeurs** sont des constantes. En référencer un vous donne des références
...
catalogue — de la même façon que les sept catalogues d'éditeurs de ce dépôt sont écrits.
