...
**Les cinq catalogues d'éditeurs** sont des constantes. En référencer un vous donne des références
...
catalogue — de la même façon que les cinq catalogues d'éditeurs de ce dépôt sont écrits.
