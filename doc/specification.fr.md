...
| --- | --- | --- |
| B1 | Nom définitif du produit. `Catalog` désigne une bibliothèque qui ne contient délibérément aucun catalogue (§2.5). Alternatives : `SuppressionContracts`, `DiagnosticRefs`. | Reporté ; un renommage est une version majeure (§23). |
