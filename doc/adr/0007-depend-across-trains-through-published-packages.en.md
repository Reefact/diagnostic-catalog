...
🌍 **Languages:**  
🇬🇧 English (this file) | 🇫🇷 [Français](./0007-depend-across-trains-through-published-packages.fr.md)
...
* [ADR-0002](0002-partition-releases-into-trains-by-commit-scope.en.md) — why the
  trains are independent.
* [ADR-0006](0006-publish-through-trusted-publishing-with-provenance-and-an-sbom.en.md).
