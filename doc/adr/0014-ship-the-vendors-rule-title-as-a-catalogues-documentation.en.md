...
🌍 **Languages:**  
🇬🇧 English (this file) | 🇫🇷 [Français](./0014-ship-the-vendors-rule-title-as-a-catalogues-documentation.fr.md)
...
Supersedes [ADR-0011](0011-redistribute-rule-facts-only-never-the-vendors-prose.en.md).

## Context

[ADR-0011](0011-redistribute-rule-facts-only-never-the-vendors-prose.en.md) decided
...
declares, which is exactly the invention [ADR-0009](0009-generate-catalog-content-from-analyzer-descriptors.en.md)
...
* [ADR-0011](0011-redistribute-rule-facts-only-never-the-vendors-prose.en.md) — the
  decision this one supersedes.
* [ADR-0009](0009-generate-catalog-content-from-analyzer-descriptors.en.md) — why a
