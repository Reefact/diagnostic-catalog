...
🌍 **Languages:**  
🇬🇧 English (this file) | 🇫🇷 [Français](./0009-generate-catalog-content-from-analyzer-descriptors.fr.md)
...
* [ADR-0010](0010-carry-a-retired-rule-forward-as-obsolete.en.md) — what happens
  when regeneration finds a rule gone.
* [ADR-0011](0011-redistribute-rule-facts-only-never-the-vendors-prose.en.md) —
