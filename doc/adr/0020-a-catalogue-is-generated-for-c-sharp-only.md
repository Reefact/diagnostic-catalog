...
* [ADR-0009](0009-generate-catalog-content-from-analyzer-descriptors.md) — content comes
  from constructed analyzers, which is why the worker's Roslyn decides the language set.
* [ADR-0010](0010-carry-a-retired-rule-forward-as-obsolete.md) — why a rule missing from a
...
* [ADR-0019](0019-resolve-packages-through-the-users-own-nuget-configuration.md) — the
