...
* [ADR-0001](0001-floor-the-libraries-on-net-framework-4-7-2.md),
  [ADR-0003](0003-adopt-and-enforce-a-conventional-commits-convention.md),
  [ADR-0004](0004-state-the-coding-rules-where-an-agent-can-act-on-them.md) —
