...
* [ADR-0009](0009-generate-catalog-content-from-analyzer-descriptors.md) — the method whose
  availability is the reason the tool is published at all.
* [ADR-0017](0017-publish-the-generator-as-a-cli-on-its-own-release-train.md) — the
