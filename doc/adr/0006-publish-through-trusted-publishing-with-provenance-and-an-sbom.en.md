...
🌍 **Languages:**  
🇬🇧 English (this file) | 🇫🇷 [Français](./0006-publish-through-trusted-publishing-with-provenance-and-an-sbom.fr.md)
...
* [ADR-0002](0002-partition-releases-into-trains-by-commit-scope.en.md) — what a
  release publishes.
* [ADR-0007](0007-depend-across-trains-through-published-packages.en.md).
