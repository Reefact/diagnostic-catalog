...
[ADR-0009](0009-generate-catalog-content-from-analyzer-descriptors.md) exists to exclude,
...
[ADR-0010](0010-carry-a-retired-rule-forward-as-obsolete.md) is not even engaged; the
...
constant is never renamed or deleted ([ADR-0012](0012-a-catalogue-never-renames-a-member-it-published.md),
...
Rejected by [ADR-0015](0015-a-catalogues-version-runs-on-its-own-line.md): a version
...
* [ADR-0009](0009-generate-catalog-content-from-analyzer-descriptors.md) — why a value that
  cannot be wrong is worth the trouble of reading descriptors.
* [ADR-0015](0015-a-catalogues-version-runs-on-its-own-line.md) — why the mirrored release
