...
🌍 **Languages:**  
🇬🇧 English (this file) | 🇫🇷 [Français](./0017-publish-the-generator-as-a-cli-on-its-own-release-train.fr.md)
...
* [ADR-0002](0002-partition-releases-into-trains-by-commit-scope.en.md) — the train
  partition this decision adds to.
* [ADR-0007](0007-depend-across-trains-through-published-packages.en.md) — the
