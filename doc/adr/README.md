...
| ADR | Title | Status |
|---|---|---|
| [ADR-0001](0001-floor-the-libraries-on-net-framework-4-7-2.md) | Floor the libraries' .NET Framework support at 4.7.2 | Proposed |
| [ADR-0002](0002-partition-releases-into-trains-by-commit-scope.md) | Partition releases into trains by commit scope | Proposed |
