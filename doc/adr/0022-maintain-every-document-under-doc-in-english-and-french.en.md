...
🌍 **Languages:**  
🇬🇧 English (this file) | 🇫🇷 [Français](./0022-maintain-every-document-under-doc-in-english-and-french.fr.md)
...
[ADR-0009](0009-generate-catalog-content-from-analyzer-descriptors.en.md) applied to
...
[ADR-0012](0012-a-catalogue-never-renames-a-member-it-published.en.md); sending them
...
* [ADR-0009](0009-generate-catalog-content-from-analyzer-descriptors.en.md) — check
