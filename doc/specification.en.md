...
analyzer it does not own. Twelve are implemented, all generated by the same tool
...
twelve catalogues and their scheduled synchronisation are specified in §14.1–§14.3
