...
analyzer it does not own. Six are implemented, all generated by the same tool
...
six catalogues and their scheduled synchronisation are specified in §14.1–§14.3
