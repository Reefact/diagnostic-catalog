...
analyzer it does not own. Ten are implemented, all generated by the same tool
...
ten catalogues and their scheduled synchronisation are specified in §14.1–§14.3
