...
analyzer it does not own. Seven are implemented, all generated by the same tool
...
seven catalogues and their scheduled synchronisation are specified in §14.1–§14.3
