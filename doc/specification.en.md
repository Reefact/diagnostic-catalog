...
analyzer it does not own. Eight are implemented, all generated by the same tool
...
eight catalogues and their scheduled synchronisation are specified in §14.1–§14.3
