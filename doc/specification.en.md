...
analyzer it does not own. Nine are implemented, all generated by the same tool
...
nine catalogues and their scheduled synchronisation are specified in §14.1–§14.3
