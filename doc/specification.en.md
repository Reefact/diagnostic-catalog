...
analyzer it does not own. Eleven are implemented, all generated by the same tool
...
eleven catalogues and their scheduled synchronisation are specified in §14.1–§14.3
