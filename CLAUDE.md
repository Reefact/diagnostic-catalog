...
* Write every commit message per [`CONTRIBUTING.md`](CONTRIBUTING.md):
  ...
  `analyzers, aspnetcore, bannedapi, cataloggen, cli, codestyle, core, mstest, netanalyzers, nunit, publicapi, roslyn, sonar, stylecop, syslib, trimming, xunit`, an imperative
