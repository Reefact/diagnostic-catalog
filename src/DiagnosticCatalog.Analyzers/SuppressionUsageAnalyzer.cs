...
public sealed class SuppressionUsageAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterCompilationStartAction(start =>
        {
            ...
            // the attribute itself — DCAT0006 is the only consumer of the index — so a project whose
            // suppressions are already catalogue references never pays for the sweep at all. Lazy<T>'s
